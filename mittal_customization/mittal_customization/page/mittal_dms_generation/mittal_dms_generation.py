...
class MitallDmsGeneration():
        ...
        if result:
            ...
            for res in result:
                ...
                txt_details += "\t".join([
                    ...
                    res.custom_serial_no_id[len(self.dms_settings.serial_no_starts):] if res.custom_serial_no_id.startswith(self.dms_settings.serial_no_starts) else res.custom_serial_no_id,
                    res.point_of_entry,
            ...
            frappe.db.set_single_value("DMS Settings", "unique_identifier", self.dms_settings.unique_identifier)
            return {
                "content": txt_details,
    ...
    def generate_osl_file(self, filters):
        query = f"""
            SELECT
                ...
                si.posting_date AS outward_delivery_date,
                '' as pos_apple_id,
        ...
        if result:
            ...
            for res in result:
                ...
                txt_details += "\t".join([
                    ...
                    getdate(res.outward_delivery_date).strftime("%Y%m%d"),
                    res.pos_apple_id,
    ...
    def generate_header(self, filters):    
        ...
        txt_details += "\t".join([
            ...
            self.now_date,
            self.dms_settings.senders_id,
            self.dms_settings.partner_type
        ])
